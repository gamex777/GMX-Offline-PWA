    ...
    constructor(Module, EJS) {
        ...
        this.EJS.on("exit", () => {
            if (!this.EJS.failedToStart) {
                try { this.saveSaveFiles(); } catch(e) {}
                try { this.functions.restart(); } catch(e) {}
                try { this.saveSaveFiles(); } catch(e) {}
            }
            try { this.toggleMainLoop(0); } catch(e) {}
            try { this.FS.unmount("/data/saves"); } catch(e) {}
            setTimeout(() => {
                try { this.Module.abort(); } catch(e) {}
                try { if (this.EJS && typeof this.EJS.destroy === "function") this.EJS.destroy(); } catch(e) {}
            }, 350);
        })
    }
